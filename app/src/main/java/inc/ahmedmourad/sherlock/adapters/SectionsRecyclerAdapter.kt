...
class SectionsRecyclerAdapter(private val sectionsList: List<AppSection>, private val onSectionSelectedListener: (Lazy<out Controller>?) -> Unit) : RecyclerView.Adapter<SectionsRecyclerAdapter.ViewHolder>() {
